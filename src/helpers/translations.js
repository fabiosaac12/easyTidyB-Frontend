const translations = {
	...
	alert: {
	    ...
	    sureToDeleteClients: 'Are you sure to delete the client?',
	    sureToDeleteProducts: 'Are you sure to delete the product?',
	    sureToDeleteOrders: 'Are you sure to delete the order?',
	    sureToDeleteSuppliers: 'Are you sure to delete the supplier?',
	...
	alert: {
	    ...
	    sureToDeleteClients: '¿Estás seguro de eliminar el cliente?',
	    sureToDeleteProducts: '¿Estás seguro de eliminar el producto?',
	    sureToDeleteOrders: '¿Estás seguro de eliminar el pedido?',
	    sureToDeleteSuppliers: '¿Estás seguro de eliminar el proveedor?',
